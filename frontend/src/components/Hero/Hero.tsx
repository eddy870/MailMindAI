...
const Hero: React.FC<HeroProps> = ({ onSubmit, apiStatus, submitting }) => {
  ...
  const fillSampleData = () => {
    setFormData({
      ...
      target_audience_description: 'Tech-savvy professionals with disposable income who value convenience and quality. They actively engage with email marketing, prefer mobile-optimized content, and typically shop during evening hours. Pain points include time constraints and information overload.',
      ...
      <div className="hero-container">
        <div className="hero-header">
          ...
          <p className="hero-subtitle">
            ...
            <br />
            <span className="open-source-note">
              🌟 Open Source Project - <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="github-link">Check out our GitHub</a>
            </span>
          </p>
        </div>
            ...
            <div className="form-main-area">
              ...
              {activeTab === 'advanced' && (
                <div className="advanced-fields">
                  ...
                  />
                  <textarea
                    placeholder="Target Audience Description (Describe your ideal customer's demographics, interests, pain points, and behaviors)"
